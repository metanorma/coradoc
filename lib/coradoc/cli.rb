...
module Coradoc
  class CLI < Thor
    ...
    option :output, type: :string, aliases: "-o", desc: "Output file to write"

    option :input_format,
           type: :string,
           aliases: "-I",
           enum: Input.keys.map(&:to_s),
           default: nil,
    ...
    option :track_time, type: :boolean, desc: "Track time spent on each step"
