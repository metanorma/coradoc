                  ...
                  {:marker=>".",
                   ...
                   :attached=>
                    [{:admonition_type=>"NOTE",
                      :content=>[{:text=>"attached admonition.", :line_break=>"\n"}]}],
                   :nested=>[]}}]}}
      expect(ast).to eq(obj)
    end
               ...
               [{:list_item=>
                  {:marker=>".",
                   ...
                   :attached=>
                    [{:paragraph=>
                       {:lines=>
                         [{:text=>"With attached paragraph.", :line_break=>"\n"}]}},
                     {:paragraph=>
                       {:lines=>
                         [{:text=>"And another attached paragraph.",
                           :line_break=>"\n"}]}}],
                   :nested=>[]}}]}}
      expect(ast).to eq(obj)
    end
                           ...
                           [{:list_item=>
                              {:marker=>"**",
                               ...
                               :attached=>
                                [{:paragraph=>
                                   {:lines=>
                                     [{:text=>"Attached paragraph.", :line_break=>"\n"}]}}],
                               :nested=>[]}}]}}]}}]}}
                 ...
                 [{:list_item=>
                  ...
                  {:list_item=>
                    {:marker=>".",
                     ...
                     :attached=>
                      [{:paragraph=>
                         {:lines=>[{:text=>"Attached paragraph.", :line_break=>"\n"}]}}],
                     :nested=>
                      [{:list=>
                         {:unordered=>
                           [{:list_item=>
